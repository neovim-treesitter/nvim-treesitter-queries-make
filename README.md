# nvim-treesitter-queries-make

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-make/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-make/actions/workflows/validate.yml)

Neovim tree-sitter queries for **make**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-make",
...
- [ ] Changes are scoped to `make` — do not include files for other languages
